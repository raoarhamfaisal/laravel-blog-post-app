...
<html lang="en">
    ...
    <body>
        <header class="header-bar mb-3">
            <div class="d-flex flex-column flex-md-row align-items-center container p-3">
                <h4 class="mr-md-auto font-weight-normal my-0"><a href="/" class="text-white">OurApp</a></h4>

                @auth
                    <div class="my-md-0 my-3 flex-row">
                        <a href="#" class="header-search-icon mr-2 text-white" title="Search" data-toggle="tooltip"
                            data-placement="bottom"><i class="fas fa-search"></i></a>
                        <span class="header-chat-icon mr-2 text-white" title="Chat" data-toggle="tooltip"
                ...
                @else
                    <form action="/login" method="POST" class="pt-md-0 mb-0 pt-2">
                        @csrf
                        <div class="row align-items-center">
                            <div class="col-md pr-md-0 mb-md-0 mb-3 mr-0">
        ...
        @auth
            <div data-username="{{ auth()->user()->username }}" data-avatar="{{ auth()->user()->avatar }}" id="chat-wrapper"
                class="chat-wrapper border-top border-left border-right shadow"></div>
        @endauth
